<?php
  require_once 'C:/xampp/htdocs/examen/vendor/autoload.php';
  ...
  $redirectUri = 'http://localhost/examen/sidebars/index.php';
 ...
 if (isset($_GET['code'])) {
     ...
     header('Location: http://localhost/examen/sidebars/index.php');
     exit;
 } else {
